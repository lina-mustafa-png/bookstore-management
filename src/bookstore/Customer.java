...
//the Customer extends the User
public class Customer extends User {
    
    private int points; //Stores the points gained from rewards
    private CustomerState state; //the current state whether its Silver or Gold
   ...
   // purchase books using points
    public double redeemAndBuy(ArrayList<Book> books) {
        ...
        updateState(); // update state if needed
        return costFinal; // return final cost
    }
